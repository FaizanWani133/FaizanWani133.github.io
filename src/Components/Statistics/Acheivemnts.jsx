import { Box, Center, Grid, Text, Wrap } from '@chakra-ui/react'
...
function Acheivemnts() {
  ...
  return (
    <Wrap  width={"100%"}   textAlign={"center"}  >
        {
            data.map(el=><Box width={"200px"}  p={3}  borderRadius={"30px"} border="2px solid #7c7ff3">
                <Text color={"teal"} fontSize={"30px"} fontWeight="900">{el.number}</Text>
